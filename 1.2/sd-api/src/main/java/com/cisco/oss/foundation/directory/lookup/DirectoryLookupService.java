...
public class DirectoryLookupService extends ServiceDirectoryService {
     ...
     */
    public static final String SD_API_POLLING_DELAY_PROPERTY = "com.cisco.oss.foundation.directory.polling.delay";

    /**
     * The default delay time of Changes Check Task in seconds .
     */
    public static final int SD_API_POLLING_DELAY_DEFAULT = 0;

    /**
     * The Changes checking interval property name in seconds.
     */
    public static final String SD_API_POLLING_INTERVAL_PROPERTY = "com.cisco.oss.foundation.directory.polling.interval";

    /**
     * The default Changes checking interval value in seconds.
     */
    public static final int SD_API_POLLING_INTERVAL_DEFAULT = 1;
    ...
    private void initChangesCheckTask() {
        int delay = getServiceDirectoryConfig().getInt(
                SD_API_POLLING_DELAY_PROPERTY,
                SD_API_POLLING_DELAY_DEFAULT);
        int interval = getServiceDirectoryConfig().getInt(
                SD_API_POLLING_INTERVAL_PROPERTY,
                SD_API_POLLING_INTERVAL_DEFAULT);
