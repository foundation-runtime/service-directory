...
public class ModelServiceInstanceCompatibleTest {
    ...
    static class ModelServiceInstance11 {
         ...
         *                     name.
         * @param port         The real port of the instance.
         * @param modifiedTime the last modified time stamp.
         * @param createTime   the create time stamp.
         * @param metadata     the metadata map.
         */
        public ModelServiceInstance11(String serviceName, String instanceId,
        ...
        public boolean equals(Object o) {
            ...
            ModelServiceInstance11 that = (ModelServiceInstance11) o;
