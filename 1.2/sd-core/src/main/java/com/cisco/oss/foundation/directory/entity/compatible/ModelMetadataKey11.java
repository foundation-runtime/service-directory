...
/**
 * NOTE: It's the 1.1 version of ModelMetadataKey, for backward compatible
 * <p>
 *
 * @since 1.2
 *
...
public class ModelMetadataKey11 {
    /**
     ...
     */
    public ModelMetadataKey11(String name) {
        this.name = name;
    }
     ...
     */
    public ModelMetadataKey11(String name, String id, Date modifiedTime,
                            Date createTime) {
        this.id = id;
        this.name = name;
     ...
     *
     * @param serviceInstances the ServiceInstance list.
     */
