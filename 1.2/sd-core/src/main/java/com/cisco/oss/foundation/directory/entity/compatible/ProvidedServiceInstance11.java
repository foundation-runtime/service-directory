...
public class ProvidedServiceInstance11 {
     ...
     * Constructor.
     */
    public ProvidedServiceInstance11() {
     ...
     *            the port.
     */
    public ProvidedServiceInstance11(String serviceName, String address, int port) {
     ...
     *            the metadata Map.
     */
    public ProvidedServiceInstance11(String serviceName, String address,
