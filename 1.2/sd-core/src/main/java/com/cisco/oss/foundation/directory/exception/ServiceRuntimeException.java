 ...
 * convert it to the ServiceException to reminder high Application.
 * So all Exception that cannot handle in ServiceDirectory should extends this exception, 
 * it will throw to the high Application.
 * 
 * @author zuxiang
 *
 */
public class ServiceRuntimeException extends RuntimeException {
	 ...
	 * 		the root Exception.
	 */
	public ServiceRuntimeException(ServiceDirectoryError ec, String message, Exception ex) {
		super(message, ex);
		this.ec = ec;
	}
	
	public ServiceRuntimeException(ErrorCode errorCode, String message, Exception ex){
		super(errorCode.getMessage() + " - " + message, ex);
		this.ec = new ServiceDirectoryError(errorCode);
	}
	...
	public ServiceRuntimeException(ErrorCode errorCode, Exception ex){
