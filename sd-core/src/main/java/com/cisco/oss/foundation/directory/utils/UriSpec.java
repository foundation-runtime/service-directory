...
public class UriSpec implements Iterable<UriSpec.Part>
{
    ...
    /**
     * If a {@link ServiceInstance} is passed when building, the replacement is {@link ServiceInstance#getServiceName()}
     */
    public static final String      FIELD_SERVICE_NAME = "serviceName";

    /**
     * If a {@link ServiceInstance} is passed when building.
     */
    public static final String      FIELD_CLIENT_ID = "cleintId";
     ...
     * If a {@link ServiceInstance} is passed when building.
     */
    public static final String      FIELD_BINDING_IP = "bindingIP";

    /**
     * If a {@link ServiceInstance} is passed when building.
     */
    public static final String      FIELD_BINDING_DOMAIN = "bindingDomain";
    ...
    public UriSpec(String rawSpec)
    {
        ...
        while ( tokenizer.hasMoreTokens() )
        {
            ...
            else
            {
                ...
                parts.add(new Part(token, isInsideVariable));
            }
        }
    ...
    public String   build(ServiceInstance serviceInstance, Map<String, Object> variables)
    {
        ...
        {
            localVariables.put(FIELD_SERVICE_NAME, nullCheck(serviceInstance.getServiceName()));
            localVariables.put(FIELD_CLIENT_ID, nullCheck(serviceInstance.getInstanceId()));
            localVariables.put(FIELD_URL, nullCheck(serviceInstance.getUri()));
        }
